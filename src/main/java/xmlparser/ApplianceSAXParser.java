...
public class ApplianceSAXParser extends DefaultHandler {
    ...
    private HouseHoldElectronics hs = null;
    private Fridge fridge = null;
    private PC pc = null;
    private Router router = null;
    private TV tv = null;

    public ApplianceList xmlParsing(String xmlDir) {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
        ...
        if (this.element.equals(APPLIANCELIST)) {
            appliance = new ApplianceList(this.fridge, this.pc, this.router, this.tv);
        }
    }
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        switch (qName) {
            case FRIDGE:
                this.fridge = new Fridge(modelName, power, onOff, capacity);
                System.out.println(fridge.toString());
                break;
            case PC:
                this.pc = new PC(modelName, power, onOff, cpuGhz, gpu);
                break;
            case ROUTER:
                this.router = new Router(modelName, power, onOff, linkSpeed, vlanFeature);
                break;
            case TV:
                this.tv = new TV(modelName, power, onOff, diagSize, dispResol);
                break;
        }
    }
}
